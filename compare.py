...
against the Hybrid Quantum microGPT (1 classical head, 3 quantum heads). 
Trains both models, runs noisy evaluation, prints a comparison table, 
and saves the loss convergence curve as a PNG.
"""
...
def run_ablation_study():
    ...
    print("                    (1 Classical Head, 3 Quantum Heads)")
    print("=" * 90)
