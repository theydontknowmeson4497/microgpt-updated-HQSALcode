"""
microgpt_classical.py

The original microGPT exactly as Karpathy wrote it, wrapped in a function 
to log execution metrics (losses, training time, parameters, and generated text).
"""
...
def train_and_evaluate(num_steps=1000):
    ...
    for step in range(num_steps):
        ...
        # Log loss
        all_step_losses.append(loss.data)
